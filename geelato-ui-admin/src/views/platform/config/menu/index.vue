<template>
  <div style="padding: 1em">
    <layout-lr title="界面" rightTitle="配置和输出" :min="{left: 10, right: 6}">
      <div slot="left">
        <div class="ui menu">
          <div class="ui basic button" @click="editor.options.display='compress'">
            <i class="compress icon"></i>
            折叠
          </div>
          <div class="ui basic button" @click="editor.options.display='expand'">
      ...
      <div slot="right">
        <sui type="tab">
          ...
          <div class="ui tab segment" data-tab="third">
            <div class="ui mini button" @click="$_getResult">获取结果</div>
...
<script>
  ...
  export default {
          ...
          menu: [
            {
              ...
              items: [
                ...
                {title: '菜单管理', href: '/#/m/platform/config/menu'}
              ]
            },
            {
              title: '设计开发',
            ...
            },
            {
              ...
              items: [
                ...
                {
                  title: '百度地图',
                  href: 'http://api.map.baidu.com/lbsapi/staticmap/staticmap-helper.html',
                  target: '_blank'
                }
              ]
            },
    ...
    methods: {
      $_getResult () {
        this.json = JSON.stringify(this.editor.json)
        this.$refs.json.$_reset(this.json)
        this.$refs.json.$_format()
      }
    },
