<template>
  <multipane class="vertical-demo vertical-panes" layout="vertical">
    ...
    <div class="pane" :style="{ width: '25%', maxWidth: '50%' }">
      <div>
        ...
        <p>
          <a href="https://github.com/yansern/vue-multipane" target="_blank">vue-multipane@github</a>
        </p>
      </div>
    </div>
  </multipane>
...
<style>
  .vertical-demo.vertical-panes {
    width: 100%;
    height: 400px;
    border: 1px solid #ccc;
  }

  .vertical-demo.vertical-panes > .pane {
    text-align: left;
    padding: 0px 5px;
    overflow: hidden;
    background: #eee;
  ...
  .vertical-demo.vertical-panes > .pane ~ .pane {
